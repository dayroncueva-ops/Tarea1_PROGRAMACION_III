...
- De hecho, la función de impresión se hizo una sola vez para evitar colocar el print dimensión por dimensión, de esta manera optimizamos el código.
- La parte lógica e implementación de las funciones y métodos podrán encontrarlo en el main.cpp con comentarios justificados.
# Ejemplo de uso:
